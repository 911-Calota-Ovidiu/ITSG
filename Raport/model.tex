...
\hypersetup{
pdftitle={Medical Certificate OCR Automation},
pdfauthor={Badea Dan-Nicolai, Badu Catalin Ioachim, Calota Ovidiu, Cibotariu Andrei},
pdfkeywords={OCR, AI, medical forms, Streamlit, Tesseract, Python},
bookmarksnumbered,
pdfstartview={FitH},
urlcolor=cyan,
colorlinks=true,
...
Badea Dan-Nicolai, Informatics,\\
Badu C\u at\u alin Ioachim, Informatics,\\
Calot\u a Ovidiu, Informatics,\\
Cibotariu Andrei, Informatics
\end{flushright}
...
Recent research (e.g., \cite{Koh06}, \cite{Storn95}) explores deep learning models (CNN, CRNN, Transformers) for handwriting recognition. While effective, these require large labeled datasets — unsuitable for our “small data” scenario.
...
\section{Data}
Testing used a small dataset (20 scanned certificates) covering:
\begin{itemize}
\item 10 printed, aligned certificates
\item 10 handwritten certificates (different doctors)
\end{itemize}
...
\hline
Certificate number & 95 & 80\\
Series & 92 & 85\\
Indemnity code & 90 & 70\\
CNP & 88 & 75\\
Emergency flag & 100 & 90\\
\hline
...
\item \textbf{Threats:} Changes in certificate template; variations in scanner quality.
\end{itemize}
...
Future improvements:
\begin{itemize}
\item Replace static ROI coordinates with template-free region detection.
\item Integrate machine learning for handwriting correction.
\item Add cloud synchronization for direct HR software integration.
\end{itemize}
